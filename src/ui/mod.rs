...
fn draw_keybar(f: &mut Frame, area: Rect, app: &App) {
    let hints: String = match app.view {
        ...
        View::Tests => "j/k select · r run · R run all · D Zed GDB · P footclient GDB · A alacritty GDB · T tmux debug · a add · e edit · d del · y dup · Enter result · o helix · v nvim · z zed · ? help · q quit".into(),
