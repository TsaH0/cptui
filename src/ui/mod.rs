...
fn draw_keybar(f: &mut Frame, area: Rect, app: &App) {
    let hints: String = match app.view {
        View::Problems => "j/k select · Enter tests · o helix · v nvim · z zed · E tmux editor · T tmux debug · b url · n add · x remove · m status · R run all · 1-4 view · ? help · q quit".into(),
        View::Tests => "j/k select · r run · R run all · D Zed GDB · P footclient GDB · A alacritty GDB · T tmux debug · E tmux editor · a add · e edit · d del · y dup · Enter result · o helix · v nvim · z zed · ? help · q quit".into(),
        View::Result => "j/k scroll · r run · R run all · E tmux editor · T tmux debug · Esc back · ? help · q quit".into(),
